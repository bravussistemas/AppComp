...
export class ProductInventory {
  ...
  getDay(day: Moment, data?: any): Observable<ProductInventoryDay[]> {
    ...
    return this.authUserHttp
      .get(this.getUrl(this.appConfig.API_PRODUCT_INVENTORY), params)
      .pipe(
        map((res: any) => {
  ...
  addOrRemoveInventory(
    ...
    return this.authUserHttp
      .post(this.getUrl(this.appConfig.API_ADD_PRODUCT_OUTPUT), data)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  changeVisibility(id: number, isVisible: boolean): Observable<any> {
    return this.authUserHttp
      .post(this.getUrl(this.appConfig.API_CHANGE_INVENTORY_VISIBILITY), {
  ...
  changeNextBatch(id: number, nextBatch: Date): Observable<any> {
    ...
    console.log(nextBatch.toJSON());
    return this.authUserHttp
      .post(this.getUrl(this.appConfig.API_CHANGE_INVENTORY_NEXT_BATCH), {
        product_inventory: id,
